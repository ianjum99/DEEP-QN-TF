...
class DeepQNetwork(object):
    def __init__(self, lr, n_actions, name, fcl_dims=256,
                 input_dims=(1000, 650, 4), chkpt_dir ='C:\Users\anthw\OneDrive\Documents\AI\MAIN\dqn'):
        self.lr = lr
        self.name = name
        ...
        self.build_network()
        self.sess.run(tf.global_variables_initiisalizer())
        ...
        def build_net(self):
            with tf.variable_scop(self.name):
        ...
        class Agent(object):
            def __init__(self, alpha, gamma, mem_size, n_actions, epsilon, batch_size,
                         replace_target=5000, input_dims=(1000, 650, 4),
                         q_next='C:\Users\anthw\OneDrive\Documents\AI\MAIN\q_next',
                         q_eval='C:\Users\anthw\OneDrive\Documents\AI\MAIN\q_eval'):
                self.n_actions = n_actions
                ...
                self.action_memory = np.zeros((self.mem_size, self.n_actions '''dype=np.int8'''))
            ...
            def learn(self):
                    ...
                    action_batch = self.action_space[batch]
